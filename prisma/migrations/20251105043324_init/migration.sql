...
-- CreateEnum
CREATE TYPE "SellerRole" AS ENUM ('MANAGER', 'ACCOUNTANT', 'INVENTORY_STAFF');

-- CreateEnum
CREATE TYPE "UserStatus" AS ENUM ('ACTIVE', 'SUSPENDED', 'BANNED');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING_APPROVAL', 'PROCESSING', 'OUT_FOR_DELIVERY', 'COMPLETED', 'CANCELLED', 'REJECTED');
